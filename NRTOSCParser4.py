...
class NRTOSCParser3:
	def __init__(self, sr=44100, anchor='/Users/kfl/', synthname='sigmaSynthAnalyzer2'):
...
#			print "total_length: " + `total_length`
	...
	def createNRTScore(self, sfpath='',
						index = 0,
						pBuf = 10,
						aBuf = 11,
						tratio = 1.0, # arg?
...
#  		print '\nTHE LIST:: ' + `oscList` + '\n'
		...
		# create the actual osc file
		self.processAndWriteFile(oscList, oscpath)
		
		# always return pwd to the anchor dir
		os.chdir(self.lib['anchor'])
		
		# return the two paths where there should be files
		return oscpath, mdpath

	# helper function that makes an MD dir if there is not already one in place
